...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { { 57.30, 184.00}, { 317.70, 184.00} }
...
//#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  55.3, 50 }, { 300.7,  50 }, { 55.3, 300 }, { 300.7, 300 } }
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>'  //kwalker - TFT Change
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.038         // (mm) Compression length applying to all extruders
  #endif
...
#define SERIAL_FLOAT_PRECISION 4 //kwalker -TFT Change
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    //#define E0_INTERPOLATE true //kwalker - all interoplate enabled above
   ...
   */
    ...
    //#define STEALTHCHOP_E  //kwalker disable per orbiter specs
  #endif
 ...
 */
#define DISABLE_DRIVER_SAFE_POWER_PROTECT  //kwalker KEEP DISABLED TO NOT FRY DRIVERS
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT  //kwalker - TFT Change
#endif
